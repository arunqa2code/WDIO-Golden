...
describe('Pre-requisites for the script', function() {
    ...
    it('Given the user enter the SKU and searches for the result', function() {
        ...
        browser.pause(1000);
        //driver.executeScript((SEARCH_TXT)).type('Hammer').click().execute( "mobile: performEditorAction", { "action": "search" } );
        //driver.pressKeyCode(84);
        
        
        //driver.execute_script("mobile:performEditorAction", {'action':'search'});
        //driver.waitForElementById($(SEARCH_TXT)).type('Hammer').click().execute( "mobile: performEditorAction", { "action": "search" } );
        //driver.waitForElementById(SEARCH_TXT).type("Hammer").click().execute( "mobile: performEditorAction", { "action": "search" } );
        // const HOMEPAGE_SEARCHTXT = '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.FrameLayout/android.widget.RelativeLayout[2]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.EditText';
        // $(HOMEPAGE_SEARCHTXT).click();
        // $(HOMEPAGE_SEARCHTXT).setValue(1000102904);
        // // browser.pause(1000);
        // driver.pressKeyCode(66);
    });
